...
if ($isSuperAdmin) {
    $adminNav['/admin'] = ['label' => 'Dashboard', 'icon' => 'fa-home'];
}

$adminNav['/admin/tournament'] = [
    'label' => $isHost ? 'My tournament' : 'Tournaments',
    'icon' => 'fa-globe',
];
$adminNav['/admin/matches'] = ['label' => 'Matches', 'icon' => 'fa-futbol'];
$adminNav['/admin/results'] = ['label' => 'Results', 'icon' => 'fa-trophy'];
$adminNav['/admin/invitations'] = ['label' => 'Invitations', 'icon' => 'fa-envelope'];
$adminNav['/admin/users'] = [
    'label' => $isSuperAdmin ? 'Users' : 'Players',
    'icon' => 'fa-users',
];
...
<head>
    ...
    <title><?= e($title ?? $panelTitle) ?> — World Cup Pool</title>
    ...
    <nav class="navbar navbar-dark bg-pool-nav">
        <div class="container-fluid">
            <span class="navbar-brand mb-0 h6">
                <i class="fa fa-shield-halved me-1"></i> <?= e($panelTitle) ?>
            </span>
...
<div class="offcanvas offcanvas-start admin-offcanvas d-lg-none"
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title text-white" id="adminMenuLabel"><?= e($panelTitle) ?> menu</h5>
        <button type="button"
...
<div class="container-fluid admin-shell">
    <div class="row">
        <aside class="col-lg-2 d-none d-lg-block admin-sidebar p-3">
            <h4 class="text-white h5"><?= e($panelTitle) ?></h4>
